...
double EuropeanDigitalPutOption::getPayoff(double spot) const {return spot <= getStrike() ? 1.0 : 0.0;} // Ternary operator: if spot <= strike, return 1.0; otherwise return 0.0